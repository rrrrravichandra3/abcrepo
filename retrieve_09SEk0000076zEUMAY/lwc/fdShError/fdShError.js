...
import fdResources from '@salesforce/resourceUrl/FrontDeskShared';
import GENERIC_ERROR_TITLE from '@salesforce/label/c.FdSh_Generic_Error_Title';
import GENERIC_ERROR_MESSAGE from '@salesforce/label/c.FdSh_Generic_Error_Text';
import ACCESS_ERROR_TITLE from '@salesforce/label/c.FdSh_Access_Error_Title';
import ACCESS_ERROR_MESSAGE from '@salesforce/label/c.FdSh_Access_Error_Text';
...
export default class FdShError extends LightningElement {
